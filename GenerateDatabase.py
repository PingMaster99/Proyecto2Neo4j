...
"""Gnerates Neo4j database for Smash Bros. Main recommendation system
Args:
    **
Returns:
    **
...
"""Creates a characters/saga/attributes in Neo4j database
Args:
...
# Deletes everything from Neo4jDatabase
def delete():
    db.delete_all()
