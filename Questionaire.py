...
tierQuestions = ["Se que es un tier en Super Smash Bros: \n (1) Si \n (2) No",
                 ...
                 " \n (2) Bueno \n (3) Normal \n (4) De los más bajos"]
jumpQuestions = ["Me cuesta regresar al mapa cuando me caigo: (1) Si \n (2) No",
